...
INSERT INTO users (first_name, last_name, email, pass, phone, role_name) VALUES 
	...
	('Morty', 'Christo', 'mc@a.ca', '$2b$12$k9bUr82TcF2uT27PCUs4Z.F/yYB.beSzSiaH4I0OUI0MhloqyGXf2','555-555-5003', 'guide'),
	('Vali', 'Vlad', 'vv@a.ca','$2b$12$k9bUr82TcF2uT27PCUs4Z.F/yYB.beSzSiaH4I0OUI0MhloqyGXf2','555-555-5004', 'guide'),
	('Mahwish', NULL, 'm@a.ca', '$2b$12$k9bUr82TcF2uT27PCUs4Z.F/yYB.beSzSiaH4I0OUI0MhloqyGXf2','555-555-5005', 'guide'),
	('Grace', 'Kim', 'gk@a.ca', '$2b$12$k9bUr82TcF2uT27PCUs4Z.F/yYB.beSzSiaH4I0OUI0MhloqyGXf2','555-555-5006', 'site manager');
...
INSERT INTO tours (route_id, guide_id, price_per_person_in_cents) VALUES 
	(1,4,9000),
	(2,4,9000),
	(1,5,9900),
	(4,5,9900),
